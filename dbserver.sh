...
echo "CREATE DATABASE subscription;" | mysql
...
echo "GRANT ALL PRIVILEGES ON subscription.* TO 'admin'@'%'" | mysql
...
cat /vagrant/setup-database.sql | mysql -u admin subscription
