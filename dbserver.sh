...
echo "CREATE DATABASE subscriptions;" | mysql
...
echo "GRANT ALL PRIVILEGES ON subscriptions.* TO 'admin'@'%'" | mysql
...
cat /vagrant/setup-database.sql | mysql -u admin subscriptions
